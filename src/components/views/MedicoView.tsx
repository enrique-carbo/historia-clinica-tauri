...
import { SoapRecord } from "../../stores/usePatientStore"; // Asumiendo que está exportado ahí
    ...
    <div className="flex flex-col gap-8">
      ...
      {activePatient ? (
        ...
        <div className="p-10 text-center bg-zinc-900/50 rounded-lg border border-dashed border-zinc-800 text-zinc-600">
          💡 Seleccioná un paciente del buscador para abrir su ficha clínica y
          redactar una evolución SOAP.
        </div>
      )}
    </div>
  );
